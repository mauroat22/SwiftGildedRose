...
/// Use this protocol to update your custom item's quality.
///
/// `Updatable` acts as a wrapper for `Item` objects, allowing for a more polymorphic solution without modifying the `Item` itself,
